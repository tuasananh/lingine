...
\begin{itemize}
    ...
    \item \textbf{Các động cơ cờ tướng đối chiếu:} \textit{Fairy-Stockfish} và \textit{Pikafish} làm các đối thủ có giới hạn sức mạnh chuẩn để chạy giải đấu ước lượng ELO và là công cụ kiểm thử tính đúng đắn của luật chơi.
