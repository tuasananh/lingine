...
def main():
    ...
    download_file("https://github.com/tuasananh/Sylvan/releases/download/v1.1.0/sylvan.tar.gz", sylvan_tar)
    ...
    download_file("https://github.com/fairy-stockfish/Fairy-Stockfish-NNUE/releases/download/xiangqi-ae0082262b68/fairy-stockfish_x86-64", fs_bin)
    ...
    download_file("https://github.com/maksimKorzh/wukong-xiangqi/raw/refs/heads/main/xqdb/xqdb/xqdb_masters_40711_UCI_games.pgn.zip", db_zip)
